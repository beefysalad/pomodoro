          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div
              style={{
                ...
                height: 28,
                borderRadius: 7,
                background: `linear-gradient(135deg,${c.violet},${c.violetMid})`,
                display: 'flex',
                alignItems: 'center',
            ...
            {tabs.map((tb) => (
              <button
                ...
                style={{
                  ...
                  boxShadow: tab === tb ? `0 0 10px ${c.violetGlow}` : 'none',
        ...
        {tab === 'colors' && (
          <div>
            <div style={{ marginBottom: 56 }}>
              ...
              >
                Deep navy. Violet that glows when earned. Orange streaks cutting
                through the cool dark. One typeface. Every weight.
              </p>
            </div>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  name: 'violet-mid',
                  hex: '#A78BFA',
                  note: 'Labels, XP text, timer',
                  glow: false,
                },
                {
                  bg: c.violetGlow,
                  name: 'violet-glow',
                  hex: 'rgba(124,58,237,0.22)',
                  note: 'Hover bg, tag bg',
                  glow: false,
                },
              ].map((s) => (
                <div key={s.name}>
                  <div
                    style={{
                      ...
                      border: `1px solid ${c.borderUp}`,
                      marginBottom: 8,
                      boxShadow: s.glow ? `0 0 24px ${c.violetGlow}` : 'none',
                    }}
                  />
                  <div style={{ fontSize: 11, fontWeight: 600, color: c.text }}>
                    {s.name}
            ...
            >
              {[
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    <span
                      style={{ fontSize: 15, fontWeight: 600, color: t.color }}
                    >
          ...
          <div>
            ...
            >
              {[
                ...
                {
                  role: 'SUBHEAD · 600 · 16px · −0.01em',
                  size: 16,
                  w: 600,
                  track: '-0.01em',
                  color: c.text,
                  s: '3 sessions · 47 minutes studied',
                },
                {
                  role: 'BODY · 400 · 13px · 0',
                  size: 13,
                  w: 400,
                  track: '0',
                  color: c.sub,
                  s: 'Focus Mode · completed 2h ago · rated ⭐⭐⭐',
                },
                {
                  role: 'LABEL · 600 · 10px · +0.15em',
                  size: 10,
                  w: 600,
                  track: '0.15em',
                  color: c.muted,
                  s: 'TOTAL TIME STUDIED',
                },
                {
                  role: 'TIMER · 800 · 52px · −0.04em',
                  size: 52,
                  w: 800,
                  track: '-0.04em',
                  color: c.violetMid,
            ...
            >
              ...
              >
                <span style={{ color: c.muted }}>{`// app/layout.tsx`}</span>
                <br />
                <span style={{ color: c.violetMid }}>import</span>{' '}
                {`{ Geist_Mono }`}{' '}
                <span style={{ color: c.violetMid }}>from</span>{' '}
                <span style={{ color: c.amber }}>
                  &apos;next/font/google&apos;
                </span>
                <br />
                <br />
                <span style={{ color: c.violetMid }}>const</span> geist =
                Geist_Mono({`{`}
                <br />
                &nbsp;&nbsp;subsets: [
                <span style={{ color: c.amber }}>&apos;latin&apos;</span>],
                <br />
                &nbsp;&nbsp;variable:{' '}
                <span style={{ color: c.amber }}>
                  &apos;--font-geist-mono&apos;
              ...
              <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                {['sm', 'md', 'lg'].map((sz, i) => (
                  <button
                    key={sz}
                    style={{
                      padding: ['5px 12px', '8px 18px', '12px 28px'][i],
                      background: c.violet,
                      color: '#fff',
            ...
            <div>
              ...
              >
                {[
                  {
                    label: 'SUBJECT NAME',
                    ph: 'e.g. Organic Chemistry',
                    hint: null,
                  },
                  {
                    label: 'TOPIC',
                    ph: 'e.g. Aldol Condensation',
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      <div
                        style={{ fontSize: 10, color: c.green, marginTop: 6 }}
                      >
                        ✓ studied today
                      </div>
                    </div>
                        ...
                        >
                          <div
                            style={{
                              ...
                              aspectRatio: '1',
                              borderRadius: 6,
                              background: done ? c.streak : c.surfaceHi,
                              border: `1px solid ${done ? c.streak : c.border}`,
                              display: 'flex',
                              alignItems: 'center',
                              justifyContent: 'center',
                              fontSize: 9,
                  ...
                  >
                    <div
                      style={{
                        width: '95%',
                        height: '100%',
                        background: `linear-gradient(90deg,${c.violet},${c.violetMid})`,
                        borderRadius: 99,
                        boxShadow: `0 0 10px ${c.violetGlow}`,
                      }}
                    />
                  </div>
            ...
            <div>
              ...
              >
                {[
                  ...
                  { mode: 'DEEP 🔬', color: c.green, time: '50:00', pct: 0.4 },
                ].map((tm) => {
                  const r = 44
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <circle
                            ...
                            strokeDashoffset={circ * (1 - tm.pct)}
                            strokeLinecap="round"
                            style={{
                              filter: `drop-shadow(0 0 6px ${tm.color}99)`,
                            }}
                          />
                        </svg>
                        <div
                      ...
                      <span
                        style={{
                          ...
                          letterSpacing: '0.12em',
                          fontWeight: 600,
                          filter: `drop-shadow(0 0 4px ${tm.color}99)`,
                        }}
                      >
                        FOCUS TIME
                      </span>
            ...
            >
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div
                    style={{
                      ...
                      justifyContent: 'center',
                      fontSize: 13,
                      boxShadow: `0 0 12px ${c.violetGlow}`,
                    }}
                  >
                    📚
                  </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                  ...
                  >
                    <span style={{ filter: 'drop-shadow(0 0 4px #EA580C)' }}>
                      🔥
                    </span>
                    <span
                      style={{ fontSize: 13, fontWeight: 800, color: c.streak }}
                    >
                      4
                    </span>
                  </div>
              ...
              <div style={{ padding: '20px 22px' }}>
                  ...
                  {['📂 SUBJECTS', '📊 HISTORY'].map((tb, i) => (
                    <div
                      ...
                      style={{
                        ...
                        padding: '7px 0',
                        borderRadius: 6,
                        background: i === 0 ? c.violetGlow : 'transparent',
                        color: i === 0 ? c.violetMid : c.muted,
                        fontSize: 11,
                        fontWeight: i === 0 ? 700 : 400,
                        textAlign: 'center',
                        letterSpacing: '0.04em',
                        boxShadow:
                          i === 0 ? `0 0 10px ${c.violetGlow}` : 'none',
                      }}
                    >
                      {tb}
                    </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {[
                        { name: 'cell-division', s: 2, p: 72 },
                        { name: 'photosynthesis', s: 1, p: 38 },
                      ].map((tp) => (
                        <div
                          key={tp.name}
                          style={{
