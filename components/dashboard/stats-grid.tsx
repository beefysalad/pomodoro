  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <motion.div 
        ...
        className="relative overflow-hidden border-streak/20 bg-gradient-to-br from-streak/10 to-streak/5 rounded-xl border p-5"
      >
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p className="text-muted-foreground/60 text-[10px] font-[600] tracking-[0.08em] uppercase mt-1">
              Keep it going
            </p>
          </div>
